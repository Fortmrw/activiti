...
<html>
	...
	<jsp:include page="../common/header.jsp"/>
		...
		<jsp:include page="../common/menu.jsp"/>
			...
			<div class="sideSubset">
				<ul>
					<li><h3>订单管理</h3></li>
					<li><a href="${ webroot}/main/order/toListOrders" class="active">订单列表</a></li>
			...
			<div class="rightCon fr">
				...
				<div class="subHead active">
					<a href="${ webroot}/main/bill/toListBills" class="active" >订单列表</a>   
				</div>
				<!--内容小导航End-->
	...
	var totalSize;
	 $(function() {
			...
			url: webroot+'/main/order/listOrders',
...
//	        		Icons:'glyphicon-export',  
			...
			//row：当前行的数据
				...
				{field: 'type', title: '订单类型', align: 'center',formatter:'typeFormatter'},
				{field: 'status', title: '订单状态', align: 'center',formatter:'statusFormatter'},
				{field: 'price', title: '订单金额', align: 'center'},
				{field: 'remark', title: '订单备注', align: 'center'},
				{field: 'orderDate', title: '订单时间', align: 'center'},
	 ...
	 function typeFormatter(value){
		 ...
		 $('#search').click(function () {
		        $table.bootstrapTable('refresh', {url:webroot+'/main/order/listOrders'});
			});
	 
		 $('#resetButton').click(function () {
			 	window.location.href=webroot+"/main/order/toListOrders";
			});
	</script>
</html>