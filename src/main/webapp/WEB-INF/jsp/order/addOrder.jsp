	...
	<section id="defaultForm" class="content">
	    ...
	    <div class="sideSubset">
	       	<ul>
				...
				<li><a href="${ webroot}/main/order/toAddOrder" class="active" >新建订单</a></li>
			</ul>
	    </div>
	    <!--小左侧End-->
			<!--右侧主题-->
			<div class="rightCon fr">
				...
				<div class="subHead active">
					<a href="${ webroot}/main/bill/toAddBill" class="active" >新建订单</a>   
				</div>
				<!--内容小导航End-->
				<div class="subjectNew">
					...
					<ul class="product_info">
						<li class="form-group">
							<h6>订单类型<font style="color: red;">*</font></h6>
